...
class McaInformationViews(viewsets.ViewSet):
    ...
    def cinMarked(self, request):
        ...
        if obj:
            ...
            obj.other_attachment_documents_present = post_data['other_attachment_documents_present'] if 'other_attachment_documents_present' in post_data.keys() else obj.other_attachment_documents_present
            obj.other_attachment_documents_information = post_data['other_attachment_documents_information'] if 'other_attachment_documents_information' in post_data.keys() else obj.other_attachment_documents_information
