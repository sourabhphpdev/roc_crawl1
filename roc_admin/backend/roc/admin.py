...
class McaInformationAdmin(ImportExportModelAdmin, ImportExportActionModelAdmin):
    list_display = ('company_name','company_cin', 'doc_present', '_doc_info', 'other_eform_documents_present', '_other_eform_documents_information','other_attachment_documents_present','_other_attachment_documents_information', 'timestamp_lastupdated', 'timestamp_added')
    ...
    def _other_attachment_documents_information(self, obj):
        if obj.other_attachment_documents_information:
            return format_html('<p style="white-space: nowrap;">' + obj.other_attachment_documents_information + '</p>')
        return obj.other_attachment_documents_information
